...
const Home = ({ navigation }) => {
  ...
  const outerCircleColor = "#FEFBEF";
  const innerCircleColor = "#F2B61A";
    ...
    >
      ...
      >
        <View style={styles.mainContainer}>
          <Text style={styles.toptext}>Tasbih</Text>
        ...
        <View style={styles.itemHeader}>
          ...
          <Pressable
            ...
            style={{ left: 40, flexDirection: "row" }}
          >
            <Text
              style={[
                { marginRight: 10, fontSize: 20, fontWeight: "500" },
          ...
          <Pressable onPress={toggleMode}>
            <Image
              style={{ height: 30, width: 30, tintColor: "#fcba03" }}
              source={
                mode === "sound"
        ...
        >
          <Text style={{ fontSize: 15, fontWeight: "500", color: "#0497DB" }}>
            View all Dikhar
          </Text>
        </Pressable>
        {bottomSheetVisible && (
